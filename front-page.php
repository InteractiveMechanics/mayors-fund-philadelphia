        ...
        <div class="container">
            ...
            <?php
                ...
                if ( !empty( $terms ) && !is_wp_error( $terms ) ): foreach ( $terms as $term ): ?>
                    <div class="col-sm-4">
                        <a class="priorityBlock" href="<?php echo get_post_type_archive_link('initiative'); ?>?q=<?php echo $term->slug; ?>">
                            <embed class="priorityIcon" src="<?php bloginfo('template_directory'); ?>/svg/gradhat.svg" alt="graduation cap icon">
